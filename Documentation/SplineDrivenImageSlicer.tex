...
\begin{figure}
\centering
\subfigure[Volume rendering]{\includegraphics[width=0.35\textwidth]{Images/mandibule_spline-3d}}
\subfigure[Axial slice]{\includegraphics[width=0.35\textwidth]{Images/mandibule_spline-2d}}
...
\begin{figure}
\centering
\subfigure[Slice at 150th point]{\includegraphics[width=0.24\textwidth]{Images/mandibule_slicer_offset150}}
\subfigure[Volume rendering with slice planes]{\includegraphics[width=0.5\textwidth]{Images/mandibule_2_slicers-3d}}
\subfigure[Slice at 350th point]{\includegraphics[width=0.24\textwidth]{Images/mandibule_slicer_offset350}}
...
\caption{3D rendering with \textit{Blender} of a volume obtained after appending all the orthogonal slices of dataset INCISIX.}
...
\caption{Visualization of a X--Z slice from a stack of X--Y spline--driven image slices}
\end{figure}
\begin{figure}
\centering
\includegraphics[width=0.8\textwidth]{Images/pano_paraview_MIP.png}
\caption{MIP of the Straightened Reformatted Volume}
\end{figure}
%
