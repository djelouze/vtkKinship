...
input spline at the specified location (OffsetLine and OffsetPoint). Image 
extent is $[0, SliceExtent[0], 0, SliceExtent[1], 0, 1]$. Image spacing is 
$[SliceSpacing[0], SliceSpacing[1], SliceThickness]$. An additional output
...
\begin{figure}
\centering
\subfigure[Volume rendering]{\includegraphics[width=0.45\textwidth]{Images/mandibule_spline-3d}}
\subfigure[Axial slice]{\includegraphics[width=0.45\textwidth]{Images/mandibule_spline-2d}}
...
\begin{figure}
\centering
\subfigure[Volume rendering]{\includegraphics[width=0.24\textwidth]{Images/mandibule_slicer_offset150}}
\subfigure[Volume rendering]{\includegraphics[width=0.5\textwidth]{Images/mandibule_2_slicers-3d}}
\subfigure[Axial slice]{\includegraphics[width=0.24\textwidth]{Images/mandibule_slicer_offset350}}
\caption{Visualization from ParaView of a mandibule CT scan and a spline}
